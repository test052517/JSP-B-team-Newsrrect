...
<body class="bg-white min-h-screen">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
            <div class="p-6">
                ...
                <div class="bg-white border border-gray-200 border-t-0 rounded-b-lg">
                    <a href="InfoWatch.jsp" class="grid grid-cols-4 gap-4 py-3 px-4 border-b border-gray-100 hover:bg-gray-50 transition-colors duration-200 cursor-pointer">
    ...
    <%-- HTML의 동적 로딩 스크립트는 정적 include로 대체하며 제거함 --%>
</body>
</html>