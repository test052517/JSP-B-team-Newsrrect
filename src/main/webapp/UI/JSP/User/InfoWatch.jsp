    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
            <div class="p-6">
                ...
                <div class="mb-6">
                    <div class="mb-6">
                        <label class="block text-sm font-medium text-gray-900 mb-2">신뢰도 nn%</label>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            <div class="p-6">
                <div class="mb-6">
                    <div class="mb-4">
                        <select class="w-32 px-3 py-2 border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-primary">
                            <option>선택</option>
                            <option>참</option>
                            <option>거짓</option>
                            <option>모호</option>
                ...
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-lg font-semibold text-gray-900">전체 댓글 6개</h3>
                ...
                <div class="mb-8 bg-blue-100 rounded-lg p-4">
                    ...
                    <div class="border border-gray-200 rounded-lg p-4 bg-white">
                        <div class="flex justify-between items-start mb-2">
                            ...
                            <div class="flex items-center space-x-2">
                                <span class="text-sm text-gray-500">작성일자</span>
                                <span class="text-gray-500 cursor-pointer" onclick="openCommentReportModal()">🚨</span>
                                <span class="px-2 py-1 bg-red-100 text-red-800 rounded text-sm">거짓</span>
                            </div>
                        </div>
                        
                        <div class="mb-3">
                            <p class="text-gray-900 mb-2">이 정보는 거짓입니다! 증거 자료 제출합니다</p>
                    ...
                    <div class="border border-gray-200 rounded-lg p-4 bg-white">
                        <div class="flex justify-between items-start mb-2">
                            <div class="flex items-center space-x-2">
                                <span class="font-semibold text-primary">BEST 사용자4</span>
                                <svg class="w-4 h-4 text-red-500" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clip-rule="evenodd"></path>
                                </svg>
                            </div>
                            <div class="flex items-center space-x-2">
                                <span class="text-sm text-gray-500">작성일자</span>
                                <span class="text-gray-500 cursor-pointer" onclick="openCommentReportModal()">🚨</span>
                                <span class="px-2 py-1 bg-yellow-100 text-yellow-800 rounded text-sm">모호</span>
                            </div>
                        </div>
                        
                        <div class="mb-3">
                            <p class="text-gray-900 mb-2">애매하네요... 모르겠습니다</p>
                ...
                <div>
                    ...
                    <div class="border border-gray-200 rounded-lg p-4 bg-white">
                        ...
                        <div class="mb-3">
                            <p class="text-gray-900 mb-2">맞습니다~ 자료 들고왔어요~ 추천 부탁드립니다~</p>
                    ...
                    <div class="border border-gray-200 rounded-lg p-4 bg-white">
                        ...
                        <div class="mb-3">
                            <p class="text-gray-900 mb-2">이거 아닌데요?</p>
