...
<body class="bg-white min-h-screen">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            <div class="p-6">
                <form id="writeForm" action="<%= request.getContextPath() %>/writeInfoPost.do" method="post" enctype="multipart/form-data" class="space-y-6">
                    <!-- 제목 입력 -->
                    <div>
                    ...
                    <!-- 카테고리 선택 -->
                    <div>
                        <label for="category" class="block text-sm font-medium text-gray-900 mb-2">카테고리</label>
                        <select id="category" name="category" 
                                class="w-full px-3 py-2 border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-primary">
